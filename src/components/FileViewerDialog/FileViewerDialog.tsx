...
import { base64ToUint8Array } from '../../utils/files';
import { Grid, Divider, Tooltip, IconButton } from '@mui/material';

interface FileViewerDialogProps extends CustomDialogProps {
        ...
        customTitle={
          <Grid container alignItems="center">
            ...
            {/* <FileDownloader
              ...
              defaultFileName={document?.nome}
              typeExpected="jpg"
              icon="download"
              helpText="Fazer download do documento"
            /> */}
            {print && (
              <Tooltip
                disableInteractive
